...
<section id="produk">
    <div class="container">
        ...
        <div class="row pt-lg-4">
            <div class="col-lg-3">
                <figure class="figure">
                    <img src="/img/iloveimg-resized/hero.jpg" class="figure-img img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                </figure>
            </div>
            <div class="col-lg-3">
                <figure class="figure">
                    <img src="/img/iloveimg-resized/hero2.jpg" class="figure-img img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                </figure>
            </div>
            <div class="col-lg-3">
                <figure class="figure">
                    <img src="/img/iloveimg-resized/hero3.jpg" class="figure-img img-fluid rounded" alt="...">
                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                </figure>
            </div>
            <div class="col-lg-3">
    ...
    <section id="pekerjaan" style="padding-top:100px;background-color:white; margin-top:-110px; background-color:#A2D9FF">
        <div class="container">
            <div class="col-lg-12 text-center ">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#ffff" fill-opacity="1" d="M0,224L48,208C96,192,192,160,288,138.7C384,117,480,107,576,122.7C672,139,768,181,864,218.7C960,256,1056,288,1152,272C1248,256,1344,192,1392,160L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
    </section>
    <section id="customer" style="padding-top:100px;margin-top:-120px;">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h1>Kustomer Kami</h1>
            </div>
            <div class="row pt-5">
                <div class="col-lg-3">
                    <figure class="figure">
                        <img src="/img/polines.png" class="figure-img img-fluid rounded" alt="...">
                        <figcaption class="figure-caption">A caption for the above image.</figcaption>
                    </figure>
                </div>
                <div class="col-lg-3">
                    <figure class="figure">
                        <img src="/img/pln.png" class="figure-img img-fluid rounded" alt="...">
                        <figcaption class="figure-caption">A caption for the above image.</figcaption>
                    </figure>
                </div>
                <div class="col-lg-3">
                    <figure class="figure">
                        <img src="/img/cnbm.png" class="figure-img img-fluid rounded" alt="...">
                        <figcaption class="figure-caption">A caption for the above image.</figcaption>
                    </figure>
                </div>
                <div class="col-lg-3">
                    <figure class="figure">
                        <img src="/img/schneider.png" class="figure-img img-fluid rounded" alt="...">
                        <figcaption class="figure-caption">A caption for the above image.</figcaption>
                    </figure>
                </div>
            </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#A2D9FF" fill-opacity="1" d="M0,224L48,208C96,192,192,160,288,138.7C384,117,480,107,576,122.7C672,139,768,181,864,218.7C960,256,1056,288,1152,272C1248,256,1344,192,1392,160L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
    </section>
    <section id="jargon" class="text-center" style="background-color:#A2D9FF">
        <h1>"Mulailah bergerak bersama kami,
            Because we work with masterpice quality"</h1>
    </section>
    <section id="about" class="p-lg-5" style="padding-top:80px;margin-top:-40px;background-color:#A2D9FF;">
        <div class="container">
            <div class="col-lg-12 pt-lg-5 text-center">
                <h1>About Us</h1>
            </div>
